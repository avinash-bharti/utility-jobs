...
hosts = [
  { 
    ...
    "instance" => "00008120-000C242E2100201E",
        ...
        { 
    "host" => "194.165.185.146",
    "instance" => "00008120-000A39E226D2201E",
                    "device" => "iPhone 15-17.0"
  },
      { 
    "host" => "194.165.185.146",
    "instance" => "00008120-000A14DA3A40201E",
                    "device" => "iPhone 15-17.0"
  },
      { 
    "host" => "194.165.185.146",
    "instance" => "00008120-000604E01AE0A01E",
                    "device" => "iPhone 15-17.0"
  },
      { 
    "host" => "194.165.185.146",
    "instance" => "00008120-000A31960284201E",
                    "device" => "iPhone 15-17.0"
  },
      { 
    "host" => "194.165.185.146",
    "instance" => "00008120-000E64E20A90A01E",
                    "device" => "iPhone 15-17.0"
  }
]
